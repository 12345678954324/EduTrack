  ...
  final List<Map<String, dynamic>> problemas = const [
    {
      ...
      'archivo': Solution1Soporte(),
    },
    {
      'titulo': 'Error de conexión',
      'archivo': Solution2Soporte(),
    },
    {
      'titulo': 'La aplicación se cierra',
      'archivo': Solution3Soporte(),
    },
    {
      'titulo': 'No cargan las calificaciones',
      'archivo': Solution4Soporte(),
    },
    {
      'titulo': 'Error al subir archivos',
      'archivo': Solution5Soporte(),
    },
  ];
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Footer con contactos (se mantiene al final)
            Padding(
