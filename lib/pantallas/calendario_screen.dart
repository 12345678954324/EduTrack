  ...
  List<Evento> _getEventsForDay(DateTime day) {
    return _todosLosEventos.where((evento) {
      final start = DateTime(
          evento.fechaInicio.year, evento.fechaInicio.month, evento.fechaInicio.day);
      final end = DateTime(
          evento.fechaFin.year, evento.fechaFin.month, evento.fechaFin.day);
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.calendar_today_rounded, color: Colors.grey.shade700, size: 18),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: RichText(
          text: TextSpan(
            children: [
              TextSpan(text: 'Calendario ', style: TextStyle(color: purpleDeep, fontSize: 20, fontWeight: FontWeight.bold)),
              TextSpan(text: 'Escolar', style: TextStyle(color: purpleMedium, fontSize: 20, fontWeight: FontWeight.w500)),
            ],
          ),
        ),
        leading: IconButton(
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(colors: [purpleLight, Colors.white]),
                        borderRadius: BorderRadius.circular(14),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Vista rápida',
                            style: TextStyle(color: purpleDeep.withOpacity(0.9), fontWeight: FontWeight.w600),
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text('${eventosAgenda.length} próximos eventos', style: const TextStyle(fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ],
                      ),
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<CalendarFormat>(
                        ...
                        items: const [
                          DropdownMenuItem(value: CalendarFormat.month, child: Text('Mes')),
                          DropdownMenuItem(value: CalendarFormat.twoWeeks, child: Text('2 Semanas')),
                          DropdownMenuItem(value: CalendarFormat.week, child: Text('Semana')),
                        ],
                        onChanged: (v) {
              ...
              child: Padding(
                ...
                child: TableCalendar<Evento>(
                  ...
                  headerStyle: HeaderStyle(
                    ...
                    titleTextStyle: TextStyle(color: purpleDeep, fontWeight: FontWeight.bold, fontSize: 16),
                    leftChevronIcon: Icon(Icons.chevron_left, color: purpleDeep),
                    rightChevronIcon: Icon(Icons.chevron_right, color: purpleDeep),
                  ),
                  calendarStyle: CalendarStyle(
                    markerDecoration: BoxDecoration(color: purpleDeep, shape: BoxShape.circle),
                    todayDecoration: BoxDecoration(color: purpleMedium.withOpacity(0.25), shape: BoxShape.circle),
                    selectedDecoration: BoxDecoration(color: purpleDeep, shape: BoxShape.circle),
                  ...
                  daysOfWeekStyle: DaysOfWeekStyle(
                    weekdayStyle: TextStyle(color: Colors.grey.shade700, fontWeight: FontWeight.w600),
                    weekendStyle: TextStyle(color: purpleDeep, fontWeight: FontWeight.w800),
                  ),
                  calendarBuilders: CalendarBuilders(
                    ...
                    dowBuilder: (context, day) {
                      final text = ['L', 'M', 'M', 'J', 'V', 'S', 'D'][day.weekday - 1];
                      return Center(
                        child: Text(text, style: TextStyle(color: Colors.grey.shade600, fontWeight: FontWeight.bold)),
                      );
                    },
                  ),
                ),
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text('Próximos eventos',
                    style: TextStyle(color: purpleDeep, fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Agregar evento (placeholder)')));
        },
      ),
    );
  }
