...
// -----------------------------------------------------------------
// 1. MODELOS DE DATOS SIMULADOS
// -----------------------------------------------------------------

// Modelo simplificado del Estudiante para esta vista
class Estudiante {
  final String id;
...
class _TeacherGradeInputScreenState extends State<TeacherGradeInputScreen> {
  ...
  // Agrega una nueva fila de formulario para ingresar una evaluación
  ...
  // Simula el guardado de datos en la base de datos (firestore/backend)
